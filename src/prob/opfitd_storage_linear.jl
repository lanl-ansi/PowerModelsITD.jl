# Definitions for solving the integrated T&D opf problem with storage opf dispatch with linear storage model.
...
function solve_opfitd_storage_linear(pm_file, pmd_file, pmitd_file, pmitd_type, optimizer; solution_processors::Vector{<:Function}=Function[], pmitd_ref_extensions::Vector{<:Function}=Vector{Function}([]), eng2math_passthrough::Dict{String,Vector{String}}=Dict{String,Vector{String}}(), make_si::Bool=true, auto_rename::Bool=false, solution_model::String="eng", kwargs...)
    ...
    return solve_model(pm_file, pmd_file, pmitd_file, pmitd_type, optimizer, build_opfitd_storage_linear; solution_processors=solution_processors, pmitd_ref_extensions=pmitd_ref_extensions, eng2math_passthrough=eng2math_passthrough, make_si=make_si, auto_rename=auto_rename, solution_model=solution_model, kwargs...)
end
...
function solve_opfitd_storage_linear(pmitd_data::Dict{String,<:Any}, pmitd_type, optimizer; solution_processors::Vector{<:Function}=Function[], pmitd_ref_extensions::Vector{<:Function}=Vector{Function}([]), eng2math_passthrough::Dict{String,Vector{String}}=Dict{String,Vector{String}}(), make_si::Bool=true, solution_model::String="eng", kwargs...)
    ...
    return solve_model(pmitd_data, pmitd_type, optimizer, build_opfitd_storage_linear; solution_processors=solution_processors, pmitd_ref_extensions=pmitd_ref_extensions, eng2math_passthrough=eng2math_passthrough, make_si=make_si, solution_model=solution_model, kwargs...)
end
...
function solve_mn_opfitd_storage_linear(pm_file, pmd_file, pmitd_file, pmitd_type, optimizer; solution_processors::Vector{<:Function}=Function[], pmitd_ref_extensions::Vector{<:Function}=Vector{Function}([]), eng2math_passthrough::Dict{String,Vector{String}}=Dict{String,Vector{String}}(), make_si::Bool=true, auto_rename::Bool=false, solution_model::String="eng", kwargs...)
    ...
    return solve_model(pm_file, pmd_file, pmitd_file, pmitd_type, optimizer, build_mn_opfitd_storage_linear; multinetwork=true, solution_processors=solution_processors, pmitd_ref_extensions=pmitd_ref_extensions, eng2math_passthrough=eng2math_passthrough, make_si=make_si, auto_rename=auto_rename, solution_model=solution_model, kwargs...)
end
...
function solve_mn_opfitd_storage_linear(pmitd_data::Dict{String,<:Any}, pmitd_type, optimizer; solution_processors::Vector{<:Function}=Function[], pmitd_ref_extensions::Vector{<:Function}=Vector{Function}([]), eng2math_passthrough::Dict{String,Vector{String}}=Dict{String,Vector{String}}(), make_si::Bool=true, solution_model::String="eng", kwargs...)
    ...
    return solve_model(pmitd_data, pmitd_type, optimizer, build_mn_opfitd_storage_linear; multinetwork=true, solution_processors=solution_processors, pmitd_ref_extensions=pmitd_ref_extensions, eng2math_passthrough=eng2math_passthrough, make_si=make_si, solution_model=solution_model, kwargs...)
end
...
"""
function build_opfitd_storage_linear(pmitd::AbstractPowerModelITD)
    ...
    for i in _PM.ids(pm_model, :storage)
        ...
        constraint_storage_losses_linear(pm_model, i)
    ...
    for i in _PMD.ids(pmd_model, :storage)
        ...
        constraint_mc_storage_losses_linear(pmd_model, i)
...
"""
function build_opfitd_storage_linear(pmitd::AbstractIVRPowerModelITD)
...
"""
function build_opfitd_storage_linear(pmitd::AbstractBFPowerModelITD)
...
"""
function build_opfitd_storage_linear(pmitd::AbstractLNLBFPowerModelITD)
...
"""
function build_mn_opfitd_storage_linear(pmitd::AbstractPowerModelITD)
    ...
    for (n, network) in nws(pmitd)
        ...
        for i in _PM.ids(pm_model, :storage, nw=n)
            constraint_storage_losses_linear(pm_model, i, nw=n)
        ...
        for i in _PMD.ids(pmd_model, n, :storage)
            constraint_mc_storage_losses_linear(pmd_model, i; nw=n)
...
"""
function build_mn_opfitd_storage_linear(pmitd::AbstractIVRPowerModelITD)
...
"""
function build_mn_opfitd_storage_linear(pmitd::AbstractBFPowerModelITD)
...
"""
function build_mn_opfitd_storage_linear(pmitd::AbstractLNLBFPowerModelITD)
